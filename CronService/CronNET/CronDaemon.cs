...
namespace CronNET
{
    ...
    {
        void AddJob(string schedule, ParameterizedThreadStart action, object arg);
        void Start();
        void Stop();
    }
    ...
    public class CronDaemon : ICronDaemon
    {
        ...
        public void AddJob(string schedule, ParameterizedThreadStart action,object arg)
        {
            var cj = new CronJob(schedule, action,arg);
            cron_jobs.Add(cj);
        }
